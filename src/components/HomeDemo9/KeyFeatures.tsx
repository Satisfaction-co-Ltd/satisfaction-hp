...
const KeyFeatures: React.FC = () => {
  return (
    <>
      <div className="key-features-wrap-area pt-100 pb-75">
        <div className="container">
          ...
          <div className="row justify-content-center">
            <div className="col-xl-4 col-lg-6 col-sm-6 col-md-6">
              <div className="key-features-card style-three">
                <div className="icon">
            ...
            <div className="col-xl-4 col-lg-6 col-sm-6 col-md-6">
              <div className="key-features-card bg-color-three style-three">
