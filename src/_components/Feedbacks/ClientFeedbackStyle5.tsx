          ...
          <div className="feedback-tabs">
            <Tabs>
              <TabPanel>
                ...
                <h6>
                  <span>James Smith</span> - Web Developer
                </h6>
              </TabPanel>
              ...
              <TabPanel>
                ...
                <h6>
                  <span>Sarah Taylor</span> - Web Designer
                </h6>
              </TabPanel>
              ...
              <TabPanel>
                <p>
                  ...
                  mail account from play store and using whatever you want for
                  your business. Cloud based storage for your data backup just
                  log in with your mail.
                </p>
                <h6>
                  <span>Andy John</span> - Developer
                </h6>
              </TabPanel>

              <TabPanel>
                <p>
                  The texap cloud based storage for your data backup just log in
                  with your mail account from play store and using whatever you
                  want for your business purpose orem ipsum dummy of your
                  business purpose text.
                </p>
                <h6>
                  <span>David Warner</span> - Web Developer
                </h6>
              </TabPanel>
              ...
              <TabPanel>
                ...
                <h6>
                  <span>Licy Tie</span> - Web Developer
                </h6>
              </TabPanel>
              ...
              <TabPanel>
                ...
                <h6>
                  <span>Any Jones</span> - Web Designer
                </h6>
              </TabPanel>
