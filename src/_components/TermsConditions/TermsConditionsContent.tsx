        ...
        <div className="container">
          <div className="terms-conditions-content">
            ...
            <p>
              ...
              only if they voluntarily consent such information to us. Users can
            ...
            <p>
              <strong>Texap</strong> accepts the following payment methods:
            </p>
            <ul>
              <li>
              ...
              <li>
                <strong>Texap</strong> features a Fast Checkout option, allowing
            ...
            <p>Last updated: January 25, 2023 at 24:00 pm</p>
          </div>
        </div>
      </div>
    </>
